...
// getting user's location
  ...
  _showRouteOnMap(route) {
    ...
    _hereMapController.camera
        .lookAtPointWithDistance(GeoCoordinates(list[0], list[1]), 8000);
  ...
  void _onMapCreated(HereMapController hereMapController) {
    ...
    _hereMapController.mapScene.loadSceneForMapScheme(MapScheme.normalDay,
      ...
      //     //   size: 40.0,
      //     // ),
      //     GeoCoordinates(widget.help.location.latitude, widget.help.location.longitude));
      moveCamera(
          latLng.LatLng(
              widget.help.location.latitude, widget.help.location.longitude),
          0);

      // addRoute(widget.help.location.latitude, widget.help.location.longitude);
      // checkHelper();
    });
...
class _RatingState extends State<Rating> {
  List<String> rateHelper = ['grey', 'grey', 'grey', 'grey', 'grey'];
  @override
  Widget build(BuildContext context) {
    return Container(
      width: 100,
      ...
      child: ListView.builder(
          ...
          itemCount: rateHelper.length,
          itemBuilder: (context, index) {
            Color color =
                rateHelper[index] == 'grey' ? Colors.grey : Colors.orange;
            return InkWell(
              onTap: () {
                print('called rate helper');
