...
class _OnGoingHelpPageState extends State<OnGoingHelpPage> {
  List<double> list = [30.275285, 77.04758];
  ...
  void _onMapCreated(HereMapController hereMapController) {
    ...
    _hereMapController.mapScene.loadSceneForMapScheme(MapScheme.normalDay,
      ...
      addRoute(31.275285, 77.04758);
      // addRoute(28.670790500000003, 77.3439178);
      checkHelper();
      ...
      hereMapController.camera.lookAtPointWithDistance(
          GeoCoordinates(28.6774576, 77.3357731), distanceToEarthInMeters);
      hereMapController.pinWidget(
          ...
          GeoCoordinates(28.6774576, 77.3357731));
    });
